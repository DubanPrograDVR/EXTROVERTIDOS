...
// NOTA: getPendingBusinesses, approveBusiness, rejectBusiness
// están definidas en businesses.js (versión canónica con lógica de cupos).
// Se exportan desde el barrel index.js vía ./businesses.
